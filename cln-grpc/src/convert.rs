...
impl From<responses::ListpeersPeersChannels> for pb::ListpeersPeersChannels {
    fn from(c: responses::ListpeersPeersChannels) -> Self {
        Self {
            ...
            channel_id: c
                .channel_id
                .map(|v| <Sha256 as AsRef<[u8]>>::as_ref(&v).to_vec()), // Rule #2 for type hash?
...
#[allow(unused_variables)]
impl From<responses::ListpeerchannelsChannelsUpdatesLocal>
    for pb::ListpeerchannelsChannelsUpdatesLocal
{
...
#[allow(unused_variables)]
impl From<responses::ListpeerchannelsChannelsUpdatesRemote>
    for pb::ListpeerchannelsChannelsUpdatesRemote
{
    ...
    fn from(c: responses::DecodeResponse) -> Self {
        Self {
            ...
            offer_chains: c
                ...
                .map(|arr| {
                    arr.into_iter()
                        .map(|i| <Sha256 as AsRef<[u8]>>::as_ref(&i).to_vec())
                        .collect()
                })
                .unwrap_or(vec![]), // Rule #3
