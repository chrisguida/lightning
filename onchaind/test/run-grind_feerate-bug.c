 ...
 *
 No valid signature found for 3 htlc_timeout_txs feerate 10992-15370, last tx
 0200000001a02a38c6ec5541963704a2a035b3094b18d69cc25cc7419d75e02894618329720000000000000000000191ea3000000000002200208bfadb3554f41cc06f00de0ec2e2f91e36ee45b5006a1f606146784755356ba532f10800,
 input 3215967sat, signature
 3045022100917efdc8577e8578aef5e513fad25edbb55921466e8ffccb05ce8bb05a54ae6902205c2fded9d7bfc290920821bfc828720bc24287f3dad9a62fb4f806e2404ed0f401,
 cltvs 585998/585998/586034 wscripts
...
u64 commit_number_obscurer(
    const struct pubkey *opener_payment_basepoint UNNEEDED,
...
bool dump_memleak_(struct htable *memtable UNNEEDED,
		   void (*print)(void *arg UNNEEDED, const char *fmt UNNEEDED,
				 ...) UNNEEDED,
		   void *arg UNNEEDED)
{
...
void fromwire_chain_coin_mvt(const u8 **cursor UNNEEDED, size_t *max UNNEEDED,
			     struct chain_coin_mvt *mvt UNNEEDED)
{
	fprintf(stderr, "fromwire_chain_coin_mvt called!\n");
	abort();
}
/* Generated stub for fromwire_ext_key */
void fromwire_ext_key(const u8 **cursor UNNEEDED, size_t *max UNNEEDED,
...
bool fromwire_hsmd_get_per_commitment_point_reply(
    const tal_t *ctx UNNEEDED, const void *p UNNEEDED,
    struct pubkey *per_commitment_point UNNEEDED,
    struct secret **old_commitment_secret UNNEEDED)
{
	fprintf(stderr,
		"fromwire_hsmd_get_per_commitment_point_reply called!\n");
	abort();
}
...
enum wallet_tx_type fromwire_wallet_tx_type(const u8 **cursor UNNEEDED,
					    size_t *max UNNEEDED)
{
...
bool fromwire_onchaind_depth(const void *p UNNEEDED,
...
bool fromwire_onchaind_htlcs(const tal_t *ctx UNNEEDED, const void *p UNNEEDED,
			     struct htlc_stub **htlc UNNEEDED,
			     bool **tell_if_missing UNNEEDED,
			     bool **tell_immediately UNNEEDED)
{
	fprintf(stderr, "fromwire_onchaind_htlcs called!\n");
	abort();
}
/* Generated stub for fromwire_onchaind_init */
bool fromwire_onchaind_init(
    const tal_t *ctx UNNEEDED, const void *p UNNEEDED,
    struct shachain *shachain UNNEEDED,
    const struct chainparams **chainparams UNNEEDED,
    struct amount_sat *funding_amount_satoshi UNNEEDED,
    struct amount_msat *our_msat UNNEEDED,
    struct pubkey *old_remote_per_commitment_point UNNEEDED,
    struct pubkey *remote_per_commitment_point UNNEEDED,
    u32 *local_to_self_delay UNNEEDED, u32 *remote_to_self_delay UNNEEDED,
    u32 *delayed_to_us_feerate UNNEEDED, u32 *htlc_feerate UNNEEDED,
    u32 *penalty_feerate UNNEEDED,
    struct amount_sat *local_dust_limit_satoshi UNNEEDED,
    struct bitcoin_txid *our_broadcast_txid UNNEEDED,
    u8 **local_scriptpubkey UNNEEDED, u8 **remote_scriptpubkey UNNEEDED,
    u32 *ourwallet_index UNNEEDED, struct ext_key *ourwallet_ext_key UNNEEDED,
    struct pubkey *ourwallet_pubkey UNNEEDED, enum side *opener UNNEEDED,
    struct basepoints *local_basepoints UNNEEDED,
    struct basepoints *remote_basepoints UNNEEDED,
    struct tx_parts **tx_parts UNNEEDED, u32 *locktime UNNEEDED,
    u32 *tx_blockheight UNNEEDED, u32 *reasonable_depth UNNEEDED,
    struct bitcoin_signature **htlc_signature UNNEEDED,
    u32 *min_possible_feerate UNNEEDED, u32 *max_possible_feerate UNNEEDED,
    struct pubkey **possible_remote_per_commit_point UNNEEDED,
    struct pubkey *local_funding_pubkey UNNEEDED,
    struct pubkey *remote_funding_pubkey UNNEEDED,
    u64 *local_static_remotekey_start UNNEEDED,
    u64 *remote_static_remotekey_start UNNEEDED,
    bool *option_anchor_outputs UNNEEDED, u32 *min_relay_feerate UNNEEDED)
{
	fprintf(stderr, "fromwire_onchaind_init called!\n");
	abort();
}
/* Generated stub for fromwire_onchaind_known_preimage */
bool fromwire_onchaind_known_preimage(const void *p UNNEEDED,
...
bool fromwire_onchaind_spent(const tal_t *ctx UNNEEDED, const void *p UNNEEDED,
			     struct tx_parts **tx UNNEEDED,
			     u32 *locktime UNNEEDED, u32 *input_num UNNEEDED,
...
void fromwire_sha256(const u8 **cursor UNNEEDED, size_t *max UNNEEDED,
		     struct sha256 *sha256 UNNEEDED)
{
	fprintf(stderr, "fromwire_sha256 called!\n");
	abort();
}
/* Generated stub for fromwire_tal_arrn */
u8 *fromwire_tal_arrn(const tal_t *ctx UNNEEDED, const u8 **cursor UNNEEDED,
		      size_t *max UNNEEDED, size_t num UNNEEDED)
{
...
void fromwire_u8_array(const u8 **cursor UNNEEDED, size_t *max UNNEEDED,
		       u8 *arr UNNEEDED, size_t num UNNEEDED)
{
...
void memleak_scan_obj(struct htable *memtable UNNEEDED,
		      const void *obj UNNEEDED)
{
...
struct chain_coin_mvt *new_coin_channel_close(
    const tal_t *ctx UNNEEDED, const struct bitcoin_txid *txid UNNEEDED,
    const struct bitcoin_outpoint *out UNNEEDED, u32 blockheight UNNEEDED,
    const struct amount_msat amount UNNEEDED,
    const struct amount_sat output_val UNNEEDED, u32 output_count)
...
new_coin_external_deposit(const tal_t *ctx UNNEEDED,
...
struct chain_coin_mvt *new_coin_external_deposit_tags(
    const tal_t *ctx UNNEEDED, const struct bitcoin_outpoint *outpoint UNNEEDED,
    u32 blockheight UNNEEDED, struct amount_sat amount UNNEEDED,
    enum mvt_tag *tags)
...
struct chain_coin_mvt *new_coin_external_spend(
    const tal_t *ctx UNNEEDED, const struct bitcoin_outpoint *outpoint UNNEEDED,
    const struct bitcoin_txid *txid UNNEEDED, u32 blockheight UNNEEDED,
    struct amount_sat amount UNNEEDED, enum mvt_tag tag)
...
struct chain_coin_mvt *new_coin_external_spend_tags(
    const tal_t *ctx UNNEEDED, const struct bitcoin_outpoint *outpoint UNNEEDED,
    const struct bitcoin_txid *txid UNNEEDED, u32 blockheight UNNEEDED,
    struct amount_sat amount UNNEEDED, enum mvt_tag *tags)
...
struct chain_coin_mvt *new_coin_wallet_deposit_tagged(
    const tal_t *ctx UNNEEDED, const struct bitcoin_outpoint *outpoint UNNEEDED,
    u32 blockheight UNNEEDED, struct amount_sat amount UNNEEDED,
...
struct chain_coin_mvt *new_onchain_htlc_deposit(
    const tal_t *ctx UNNEEDED, const struct bitcoin_outpoint *outpoint UNNEEDED,
    u32 blockheight UNNEEDED, struct amount_sat amount UNNEEDED,
...
struct chain_coin_mvt *new_onchain_htlc_withdraw(
    const tal_t *ctx UNNEEDED, const struct bitcoin_outpoint *outpoint UNNEEDED,
    u32 blockheight UNNEEDED, struct amount_sat amount UNNEEDED,
    const struct sha256 *payment_hash)
...
struct chain_coin_mvt *
new_onchaind_deposit(const tal_t *ctx UNNEEDED,
		     const struct bitcoin_outpoint *outpoint UNNEEDED,
		     u32 blockheight UNNEEDED,
		     struct amount_sat amount UNNEEDED, enum mvt_tag tag)
...
struct chain_coin_mvt *new_onchaind_withdraw(
    const tal_t *ctx UNNEEDED, const struct bitcoin_outpoint *outpoint UNNEEDED,
    const struct bitcoin_txid *spend_txid UNNEEDED, u32 blockheight UNNEEDED,
    struct amount_sat amount UNNEEDED, enum mvt_tag tag)
...
u8 *to_self_wscript(const tal_t *ctx UNNEEDED, u16 to_self_delay UNNEEDED,
		    u32 csv UNNEEDED, const struct keyset *keyset UNNEEDED)
{
...
void towire_chain_coin_mvt(u8 **pptr UNNEEDED,
...
u8 *towire_hsmd_get_per_commitment_point(const tal_t *ctx UNNEEDED,
					 u64 n UNNEEDED)
{
...
void towire_htlc_stub(u8 **pptr UNNEEDED,
		      const struct htlc_stub *htlc_stub UNNEEDED)
{
	fprintf(stderr, "towire_htlc_stub called!\n");
	abort();
}
/* Generated stub for towire_shachain */
void towire_shachain(u8 **pptr UNNEEDED,
		     const struct shachain *shachain UNNEEDED)
{
...
void towire_wallet_tx_type(u8 **pptr UNNEEDED,
			   const enum wallet_tx_type type UNNEEDED)
{
...
u8 *towire_hsmd_sign_local_htlc_tx(const tal_t *ctx UNNEEDED,
				   u64 commit_num UNNEEDED,
...
bool fromwire_hsmd_sign_tx_reply(const void *p UNNEEDED,
...
void status_fmt(enum log_level level UNNEEDED, const struct node_id *node_id,
		const char *fmt UNNEEDED, ...)
{
}
...
struct bitcoin_tx *htlc_timeout_tx(
    ...
    const struct bitcoin_outpoint *commit UNNEEDED, const u8 *commit_wscript,
    ...
    bool option_anchors_zero_fee_htlc_tx, bool option_commit_zero_fees)
{
	...
	tx = bitcoin_tx_from_hex(
	    ctx,
	    "0200000001a02a38c6ec5541963704a2a035b3094b18d69cc25cc7419d75e02894"
	    "618329720000000000000000000191ea3000000000002200208bfadb3554f41cc0"
	    "6f00de0ec2e2f91e36ee45b5006a1f606146784755356ba532f10800",
	    strlen("0200000001a02a38c6ec5541963704a2a035b3094b18d69cc25cc7419d7"
		   "5e02894618329720000000000000000000191ea3000000000002200208b"
		   "fadb3554f41cc06f00de0ec2e2f91e36ee45b5006a1f606146784755356"
		   "ba532f10800"));
	assert(tx);
...
int main(int argc, char *argv[])
{
	...
	htlcs[1].id = 0;
	htlcs[2].id = 0;
	htlc_scripts[0] = tal_hexdata(
	    tmpctx,
	    "76a914f454b1fe5b95428d6beec58ed3131a6ea611b2fa8763ac672103f83ca95b"
	    "22920e71487736a7284696dd52443fd8f7ce683153ac31d1d1db7da67c82012087"
	    "6475527c21026ebaa1d08757b86110e40e3f4a081803eec694e23ec75ee0bfd753"
	    "589df896e752ae67a9148dbcec4a5d782dd87588801607ea7dfc8874ffee88ac68"
	    "68",
	    strlen("76a914f454b1fe5b95428d6beec58ed3131a6ea611b2fa8763ac672103f"
		   "83ca95b22920e71487736a7284696dd52443fd8f7ce683153ac31d1d1db"
		   "7da67c820120876475527c21026ebaa1d08757b86110e40e3f4a081803e"
		   "ec694e23ec75ee0bfd753589df896e752ae67a9148dbcec4a5d782dd875"
		   "88801607ea7dfc8874ffee88ac6868"));
	htlc_scripts[1] = tal_hexdata(
	    tmpctx,
	    "76a914f454b1fe5b95428d6beec58ed3131a6ea611b2fa8763ac672103f83ca95b"
	    "22920e71487736a7284696dd52443fd8f7ce683153ac31d1d1db7da67c82012087"
	    "6475527c21026ebaa1d08757b86110e40e3f4a081803eec694e23ec75ee0bfd753"
	...
	bitcoin_txid_from_hex(
	    ...
	    strlen("722983619428e0759d41c75cc29cd6184b09b335a0a20437964155ecc63"
		   "82aa0"),
	    &out->outpoint.txid);
	out->outpoint.n = 0;
	if (!parse_amount_sat(&out->sat, "3215967sat", strlen("3215967sat")))
		abort();
	signature_from_hex("3045022100917efdc8577e8578aef5e513fad25edbb55921466"
			   "e8ffccb05ce8bb05a54ae6902205c2fded9d7bfc290920821bf"
			   "c828720bc24287f3dad9a62fb4f806e2404ed0f401",
			   &remotesig);
	out->remote_htlc_sig =
	    tal_dup(out, struct bitcoin_signature, &remotesig);
	...
	if (!pubkey_from_hexstr("03f83ca95b22920e71487736a7284696dd52443fd8f7ce"
				"683153ac31d1d1db7da6",
				strlen("03f83ca95b22920e71487736a7284696dd52443"
				       "fd8f7ce683153ac31d1d1db7da6"),
				&keys->other_htlc_key))
		abort();
	/* resolve_our_htlc_ourcommit wants these too; set to anything valid. */
	keys->self_revocation_key = keys->self_delayed_payment_key =
	    keys->other_htlc_key;
	...
	size_t ret =
	    resolve_our_htlc_ourcommit(out, matches, htlcs, htlc_scripts);
