...
const char *feature_place_names[] = {"init", NULL, "node", "channel",
				     "invoice"};
...
static const struct feature_style feature_styles[] = {
    ...
    {OPT_GOSSIP_QUERIES_EX,
     .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
		    [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT}},
    {OPT_VAR_ONION, .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
    ...
    {OPT_COMMIT_ZERO_FEES,
     .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
		    [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT,
		    [CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
    {OPT_DUAL_FUND, .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
				   [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT,
				   [BOLT11_FEATURE] = FEATURE_REPRESENT,
				   [CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
     ...
     * `mindepth`.
     */
    {OPT_ZEROCONF, .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
				  [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT,
				  [BOLT11_FEATURE] = FEATURE_DONT_REPRESENT,
				  [CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
    {OPT_ROUTE_BLINDING,
    ...
    {OPT_SHUTDOWN_ANYSEGWIT,
     .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
		    [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT,
		    [CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
    {OPT_QUIESCE, .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
				 [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT,
				 [CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
    ...
    {OPT_PROVIDE_PEER_BACKUP_STORAGE,
     .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
		    [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT}},
    {OPT_SPLICE, .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
				[NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT,
				[CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
    {OPT_EXPERIMENTAL_SPLICE,
     .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
		    [NODE_ANNOUNCE_FEATURE] = FEATURE_REPRESENT,
		    [CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
    {OPT_ELTOO, .copy_style = {[INIT_FEATURE] = FEATURE_REPRESENT,
			       [NODE_ANNOUNCE_FEATURE] = FEATURE_DONT_REPRESENT,
			       [BOLT11_FEATURE] = FEATURE_DONT_REPRESENT,
			       [CHANNEL_FEATURE] = FEATURE_DONT_REPRESENT}},
};
...
static int all_supported_features(const struct feature_set *our_features,
				  const u8 *bitmap, enum feature_place p)
{
...
const char *feature_name(const tal_t *ctx, size_t f)
{
	static const char *fnames[] = {
	    ...
	    "option_dual_fund",
	    "option_amp",
	    /* 30/31 */ /* https://github.com/lightning/bolts/pull/658 */
	    NULL,
	    "option_quiesce", /* https://github.com/lightning/bolts/pull/869 */
	    NULL,
	    "option_onion_messages", /* https://github.com/lightning/bolts/pull/759
				      */
	    "option_want_peer_backup_storage",
	    /* 40/41 */ /* https://github.com/lightning/bolts/pull/881/files */
	...
	return tal_fmt(ctx, "%s/%s", fnames[f / 2], (f & 1) ? "odd" : "even");
}
...
struct feature_set *fromwire_feature_set(const tal_t *ctx, const u8 **cursor,
					 size_t *max)
{
...
void towire_feature_set(u8 **pptr, const struct feature_set *fset)
{
	for (size_t i = 0; i < ARRAY_SIZE(fset->bits); i++) {
		...
		towire_u8_array(pptr, fset->bits[i],
				tal_bytelen(fset->bits[i]));
	}
}
