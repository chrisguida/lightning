...
static void db_log_(struct logger *log UNUSED, enum log_level level UNUSED,
		    const struct node_id *node_id UNUSED,
		    bool call_notifier UNUSED, const char *fmt UNUSED, ...)
{
}
#define log_ db_log_
...
static void test_error(struct lightningd *ld, bool fatal, const char *fmt,
		       va_list ap)
{
...
struct bitcoin_tx **
bind_txs_to_funding_outpoint(const struct bitcoin_tx *update_tx UNNEEDED,
...
struct bitcoin_tx **bind_txs_to_update_outpoint(
    const struct bitcoin_tx *update_tx UNNEEDED,
...
struct bolt11 *bolt11_decode(const tal_t *ctx UNNEEDED,
...
void broadcast_tx_(
    const tal_t *ctx UNNEEDED, struct chain_topology *topo UNNEEDED,
    struct channel *channel UNNEEDED,
    const struct bitcoin_tx *tx TAKES UNNEEDED, const char *cmd_id UNNEEDED,
    bool allowhighfees UNNEEDED, u32 minblock UNNEEDED,
    bool (*finished)(struct channel *UNNEEDED,
		     const struct bitcoin_tx *UNNEEDED, bool success UNNEEDED,
		     const char *err UNNEEDED, void *) UNNEEDED,
    bool (*refresh)(struct channel *UNNEEDED,
		    const struct bitcoin_tx **UNNEEDED, void *) UNNEEDED,
...
void channel_unsaved_close_conn(struct channel *channel UNNEEDED,
...
void channel_update_feerates(struct lightningd *ld UNNEEDED,
...
struct command_result *command_fail(struct command *cmd UNNEEDED,
...
void connect_succeeded(struct lightningd *ld UNNEEDED,
		       const struct peer *peer UNNEEDED, bool incoming UNNEEDED,
		       const struct wireaddr_internal *addr UNNEEDED)
{
...
create_anchor_details(const tal_t *ctx UNNEEDED,
		      struct channel *channel UNNEEDED,
...
struct onionpacket *create_onionpacket(const tal_t *ctx UNNEEDED,
...
struct onionreply *
create_onionreply(const tal_t *ctx UNNEEDED,
...
char *
encode_scriptpubkey_to_addr(const tal_t *ctx UNNEEDED,
...
u64 forward_index_update_status(
    struct lightningd *ld UNNEEDED, enum forward_status status UNNEEDED,
    struct short_channel_id in_channel UNNEEDED, u64 in_htlc_id UNNEEDED,
    struct amount_msat in_amount UNNEEDED,
    const struct short_channel_id *out_channel UNNEEDED)
{
...
bool fromwire_channeld_dev_memleak_reply(const void *p UNNEEDED,
					 bool *leak UNNEEDED)
{
...
bool fromwire_channeld_got_ack(const tal_t *ctx UNNEEDED,
			       const void *p UNNEEDED, u64 *updatenum UNNEEDED,
			       struct changed_htlc **changed UNNEEDED,
			       struct partial_sig *their_psig UNNEEDED,
			       struct partial_sig *our_psig UNNEEDED,
			       struct musig_session *session UNNEEDED)
{
...
bool fromwire_channeld_got_commitsig(
    ...
    struct fee_states **fee_states UNNEEDED,
    struct height_states **blockheight_states UNNEEDED,
    struct bitcoin_signature *signature UNNEEDED,
    struct bitcoin_signature **htlc_signature UNNEEDED,
    struct added_htlc **added UNNEEDED,
    struct fulfilled_htlc **fulfilled UNNEEDED,
    struct failed_htlc ***failed UNNEEDED,
    struct changed_htlc **changed UNNEEDED, struct bitcoin_tx **tx UNNEEDED,
    struct commitsig ***inflight_commitsigs UNNEEDED)
{
	fprintf(stderr, "fromwire_channeld_got_commitsig called!\n");
	abort();
}
/* Generated stub for fromwire_channeld_got_revoke */
bool fromwire_channeld_got_revoke(
    const tal_t *ctx UNNEEDED, const void *p UNNEEDED, u64 *revokenum UNNEEDED,
    struct secret *per_commitment_secret UNNEEDED,
    struct pubkey *next_per_commit_point UNNEEDED,
    struct fee_states **fee_states UNNEEDED,
    struct height_states **blockheight_states UNNEEDED,
    struct changed_htlc **changed UNNEEDED,
    struct penalty_base **pbase UNNEEDED,
    struct bitcoin_tx **penalty_tx UNNEEDED)
{
	fprintf(stderr, "fromwire_channeld_got_revoke called!\n");
	abort();
}
/* Generated stub for fromwire_channeld_got_updatesig */
bool fromwire_channeld_got_updatesig(const tal_t *ctx UNNEEDED,
				     const void *p UNNEEDED,
				     u32 *update_num UNNEEDED,
				     struct partial_sig *our_p_sig UNNEEDED,
				     struct partial_sig *their_p_sig UNNEEDED,
				     struct musig_session *session UNNEEDED,
				     struct added_htlc **added UNNEEDED,
				     struct fulfilled_htlc **fulfilled UNNEEDED,
				     struct failed_htlc ***failed UNNEEDED,
				     struct changed_htlc **changed UNNEEDED,
				     struct bitcoin_tx **update_tx UNNEEDED,
				     struct bitcoin_tx **settle_tx UNNEEDED)
{
...
bool fromwire_channeld_offer_htlc_reply(const tal_t *ctx UNNEEDED,
					const void *p UNNEEDED,
					u64 *id UNNEEDED,
					u8 **failuremsg UNNEEDED,
					wirestring **failurestr UNNEEDED)
{
	fprintf(stderr, "fromwire_channeld_offer_htlc_reply called!\n");
	abort();
}
/* Generated stub for fromwire_channeld_resending_updatesig */
bool fromwire_channeld_resending_updatesig(
    const void *p UNNEEDED, u64 *update_num UNNEEDED,
    struct partial_sig *our_update_p_sig UNNEEDED,
    struct musig_session *session UNNEEDED)
{
...
bool fromwire_channeld_sending_updatesig(
    const tal_t *ctx UNNEEDED, const void *p UNNEEDED, u64 *update_num UNNEEDED,
    struct changed_htlc **changed UNNEEDED,
    struct partial_sig *our_update_p_sig UNNEEDED,
    struct musig_session *session UNNEEDED,
    struct bitcoin_tx **update_tx UNNEEDED,
...
bool fromwire_connectd_peer_connected(const tal_t *ctx UNNEEDED,
				      const void *p UNNEEDED,
				      struct node_id *id UNNEEDED,
				      u64 *counter UNNEEDED,
				      struct wireaddr_internal *addr UNNEEDED,
				      struct wireaddr **remote_addr UNNEEDED,
				      bool *incoming UNNEEDED,
				      u8 **features UNNEEDED)
{
	fprintf(stderr, "fromwire_connectd_peer_connected called!\n");
	abort();
}
/* Generated stub for fromwire_connectd_peer_disconnect_done */
bool fromwire_connectd_peer_disconnect_done(const void *p UNNEEDED,
					    struct node_id *id UNNEEDED,
					    u64 *counter UNNEEDED)
{
...
bool fromwire_connectd_peer_spoke(const tal_t *ctx UNNEEDED,
				  const void *p UNNEEDED,
				  struct node_id *id UNNEEDED,
				  u64 *counter UNNEEDED, u16 *msgtype UNNEEDED,
				  struct channel_id *channel_id UNNEEDED,
				  wirestring **error UNNEEDED)
{
	fprintf(stderr, "fromwire_connectd_peer_spoke called!\n");
	abort();
}
/* Generated stub for fromwire_dualopend_dev_memleak_reply */
bool fromwire_dualopend_dev_memleak_reply(const void *p UNNEEDED,
					  bool *leak UNNEEDED)
{
...
bool fromwire_hsmd_derive_secret_reply(const void *p UNNEEDED,
...
bool fromwire_hsmd_get_output_scriptpubkey_reply(const tal_t *ctx UNNEEDED,
						 const void *p UNNEEDED,
						 u8 **script UNNEEDED)
{
	fprintf(stderr,
		"fromwire_hsmd_get_output_scriptpubkey_reply called!\n");
	abort();
}
/* Generated stub for fromwire_hsmd_init_reply_v2 */
bool fromwire_hsmd_init_reply_v2(const void *p UNNEEDED,
				 struct node_id *node_id UNNEEDED,
				 struct ext_key *bip32 UNNEEDED,
				 struct pubkey *bolt12 UNNEEDED)
{
	fprintf(stderr, "fromwire_hsmd_init_reply_v2 called!\n");
	abort();
}
/* Generated stub for fromwire_hsmd_init_reply_v4 */
bool fromwire_hsmd_init_reply_v4(const tal_t *ctx UNNEEDED,
				 const void *p UNNEEDED,
				 u32 *hsm_version UNNEEDED,
				 u32 **hsm_capabilities UNNEEDED,
				 struct node_id *node_id UNNEEDED,
				 struct ext_key *bip32 UNNEEDED,
				 struct pubkey *bolt12 UNNEEDED)
{
...
bool fromwire_hsmd_sign_commitment_tx_reply(
    const void *p UNNEEDED, struct bitcoin_signature *sig UNNEEDED)
{
	fprintf(stderr, "fromwire_hsmd_sign_commitment_tx_reply called!\n");
	abort();
}
/* Generated stub for fromwire_hsmstatus_client_bad_request */
bool fromwire_hsmstatus_client_bad_request(const tal_t *ctx UNNEEDED,
					   const void *p UNNEEDED,
					   struct node_id *id UNNEEDED,
					   wirestring **description UNNEEDED,
					   u8 **msg UNNEEDED)
{
...
bool fromwire_onchaind_dev_memleak_reply(const void *p UNNEEDED,
					 bool *leak UNNEEDED)
{
...
bool fromwire_openingd_dev_memleak_reply(const void *p UNNEEDED,
					 bool *leak UNNEEDED)
{
...
void htlc_set_add(struct lightningd *ld UNNEEDED, struct htlc_in *hin UNNEEDED,
...
invoice_check_payment(const tal_t *ctx UNNEEDED, struct lightningd *ld UNNEEDED,
...
struct tlv_invoice *invoice_decode(
    const tal_t *ctx UNNEEDED, const char *b12 UNNEEDED, size_t b12len UNNEEDED,
    const struct feature_set *our_features UNNEEDED,
    const struct chainparams *must_be_chain UNNEEDED, char **fail UNNEEDED)
{
...
bool invoices_resolve(struct invoices *invoices UNNEEDED, u64 inv_dbid UNNEEDED,
...
void json_add_address(struct json_stream *response UNNEEDED,
...
void json_add_bool(struct json_stream *result UNNEEDED,
		   const char *fieldname UNNEEDED, bool value UNNEEDED)
{
...
void json_add_hex(struct json_stream *result UNNEEDED,
		  const char *fieldname UNNEEDED, const void *data UNNEEDED,
		  size_t len UNNEEDED)
{
...
void json_add_jsonstr(struct json_stream *js UNNEEDED,
		      const char *fieldname UNNEEDED,
		      const char *jsonstr UNNEEDED, size_t jsonstrlen UNNEEDED)
{
...
void json_add_num(struct json_stream *result UNNEEDED,
		  const char *fieldname UNNEEDED, unsigned int value UNNEEDED)
{
	fprintf(stderr, "json_add_num called!\n");
	abort();
}
/* Generated stub for json_add_preimage */
void json_add_preimage(struct json_stream *result UNNEEDED,
		       const char *fieldname UNNEEDED,
...
void json_add_s32(struct json_stream *result UNNEEDED,
		  const char *fieldname UNNEEDED, int32_t value UNNEEDED)
{
	fprintf(stderr, "json_add_s32 called!\n");
	abort();
}
/* Generated stub for json_add_s64 */
void json_add_s64(struct json_stream *result UNNEEDED,
		  const char *fieldname UNNEEDED, int64_t value UNNEEDED)
{
...
void json_add_u32(struct json_stream *result UNNEEDED,
		  const char *fieldname UNNEEDED, uint32_t value UNNEEDED)
{
	fprintf(stderr, "json_add_u32 called!\n");
	abort();
}
/* Generated stub for json_add_u64 */
void json_add_u64(struct json_stream *result UNNEEDED,
		  const char *fieldname UNNEEDED, uint64_t value UNNEEDED)
{
...
void json_array_start(struct json_stream *js UNNEEDED,
		      const char *fieldname UNNEEDED)
{
...
const jsmntok_t *json_get_member(const char *buffer UNNEEDED,
...
void json_object_start(struct json_stream *ks UNNEEDED,
		       const char *fieldname UNNEEDED)
{
...
char *json_strdup(const tal_t *ctx UNNEEDED, const char *buffer UNNEEDED,
		  const jsmntok_t *tok UNNEEDED)
{
...
bool json_to_channel_id(const char *buffer UNNEEDED,
			const jsmntok_t *tok UNNEEDED,
...
bool json_to_preimage(const char *buffer UNNEEDED,
		      const jsmntok_t *tok UNNEEDED,
...
bool json_to_short_channel_id(const char *buffer UNNEEDED,
			      const jsmntok_t *tok UNNEEDED,
...
u8 *json_tok_bin_from_hex(const tal_t *ctx UNNEEDED,
...
bool json_tok_channel_id(const char *buffer UNNEEDED,
			 const jsmntok_t *tok UNNEEDED,
			 struct channel_id *cid UNNEEDED)
{
...
const char *json_tok_full(const char *buffer UNNEEDED,
			  const jsmntok_t *t UNNEEDED)
{
...
bool json_tok_streq(const char *buffer UNNEEDED, const jsmntok_t *tok UNNEEDED,
		    const char *str UNNEEDED)
{
...
void logv(struct logger *logger UNNEEDED, enum log_level level UNNEEDED,
	  const struct node_id *node_id UNNEEDED, bool call_notifier UNNEEDED,
...
new_channel_mvt_invoice_hin(const tal_t *ctx UNNEEDED,
...
struct channel_coin_mvt *
new_channel_mvt_invoice_hout(const tal_t *ctx UNNEEDED,
...
struct channel_coin_mvt *
new_channel_mvt_routed_hin(const tal_t *ctx UNNEEDED,
			   struct htlc_in *hin UNNEEDED,
			   struct channel *channel UNNEEDED)
{
...
struct channel_coin_mvt *
new_channel_mvt_routed_hout(const tal_t *ctx UNNEEDED,
			    struct htlc_out *hout UNNEEDED,
			    struct channel *channel UNNEEDED)
{
...
new_coin_wallet_deposit(const tal_t *ctx UNNEEDED,
			const struct bitcoin_outpoint *outpoint UNNEEDED,
			u32 blockheight UNNEEDED,
			struct amount_sat amount UNNEEDED, enum mvt_tag tag)
...
struct subd *
new_global_subd(struct lightningd *ld UNNEEDED, const char *name UNNEEDED,
...
void notify_chain_mvt(struct lightningd *ld UNNEEDED,
		      const struct chain_coin_mvt *mvt UNNEEDED)
{
...
void notify_channel_mvt(struct lightningd *ld UNNEEDED,
			const struct channel_coin_mvt *mvt UNNEEDED)
{
...
void notify_disconnect(struct lightningd *ld UNNEEDED,
...
onion_decode(const tal_t *ctx UNNEEDED, bool blinding_support UNNEEDED,
	     const struct route_step *rs UNNEEDED,
	     const struct pubkey *blinding UNNEEDED,
	     const u64 *accepted_extra_tlvs UNNEEDED,
	     struct amount_msat amount_in UNNEEDED, u32 cltv_expiry UNNEEDED,
	     u64 *failtlvtype UNNEEDED, size_t *failtlvpos UNNEEDED)
{
...
struct command_result *param_bin_from_hex(struct command *cmd UNNEEDED,
...
struct command_result *param_bool(struct command *cmd UNNEEDED,
				  const char *name UNNEEDED,
				  const char *buffer UNNEEDED,
				  const jsmntok_t *tok UNNEEDED,
				  bool **b UNNEEDED)
...
bool param_check(struct command *cmd UNNEEDED, const char *buffer UNNEEDED,
...
struct command_result *param_hops_array(struct command *cmd UNNEEDED,
					const char *name UNNEEDED,
					const char *buffer UNNEEDED,
					const jsmntok_t *tok UNNEEDED,
...
struct command_result *param_invstring(struct command *cmd UNNEEDED,
				       const char *name UNNEEDED,
				       const char *buffer UNNEEDED,
				       const jsmntok_t *tok UNNEEDED,
				       const char **str UNNEEDED)
...
struct command_result *param_msat(struct command *cmd UNNEEDED,
				  const char *name UNNEEDED,
				  const char *buffer UNNEEDED,
				  const jsmntok_t *tok UNNEEDED,
				  struct amount_msat **msat UNNEEDED)
...
struct command_result *param_number(struct command *cmd UNNEEDED,
				    const char *name UNNEEDED,
				    const char *buffer UNNEEDED,
				    const jsmntok_t *tok UNNEEDED,
				    unsigned int **num UNNEEDED)
...
struct command_result *param_secret(struct command *cmd UNNEEDED,
				    const char *name UNNEEDED,
				    const char *buffer UNNEEDED,
				    const jsmntok_t *tok UNNEEDED,
				    struct secret **secret UNNEEDED)
...
struct command_result *param_sha256(struct command *cmd UNNEEDED,
				    const char *name UNNEEDED,
				    const char *buffer UNNEEDED,
				    const jsmntok_t *tok UNNEEDED,
...
param_short_channel_id(struct command *cmd UNNEEDED, const char *name UNNEEDED,
		       const char *buffer UNNEEDED,
		       const jsmntok_t *tok UNNEEDED,
		       struct short_channel_id **scid UNNEEDED)
{
...
struct command_result *param_string(struct command *cmd UNNEEDED,
				    const char *name UNNEEDED,
				    const char *buffer UNNEEDED,
				    const jsmntok_t *tok UNNEEDED,
				    const char **str UNNEEDED)
...
struct command_result *param_u32(struct command *cmd UNNEEDED,
				 const char *name UNNEEDED,
				 const char *buffer UNNEEDED,
				 const jsmntok_t *tok UNNEEDED,
...
struct command_result *param_u64(struct command *cmd UNNEEDED,
				 const char *name UNNEEDED,
				 const char *buffer UNNEEDED,
				 const jsmntok_t *tok UNNEEDED,
...
bool peer_start_channeld(struct channel *channel UNNEEDED,
			 struct peer_fd *peer_fd UNNEEDED,
			 const u8 *fwd_msg UNNEEDED, bool reconnected UNNEEDED,
...
bool peer_start_dualopend(struct peer *peer UNNEEDED,
			  struct peer_fd *peer_fd UNNEEDED,
			  struct channel *channel UNNEEDED)
{
...
bool peer_start_openingd(struct peer *peer UNNEEDED,
			 struct peer_fd *peer_fd UNNEEDED, bool eltoo UNNEEDED)
{
...
struct route_step *process_onionpacket(
    const tal_t *ctx UNNEEDED, const struct onionpacket *packet UNNEEDED,
    const struct secret *shared_secret UNNEEDED, const u8 *assocdata UNNEEDED,
    const size_t assocdatalen UNNEEDED, bool has_realm)
{
...
void report_subd_memleak(struct leak_detect *leak_detect UNNEEDED,
			 struct subd *leaker UNNEEDED)
{
	fprintf(stderr, "report_subd_memleak called!\n");
	abort();
}
/* Generated stub for resolve_close_command */
void resolve_close_command(struct lightningd *ld UNNEEDED,
			   struct channel *channel UNNEEDED,
			   bool cooperative UNNEEDED,
			   const struct bitcoin_tx *close_tx UNNEEDED)
{
	fprintf(stderr, "resolve_close_command called!\n");
	abort();
}
/* Generated stub for rune_is_ours */
const char *rune_is_ours(struct lightningd *ld UNNEEDED,
			 const struct rune *rune UNNEEDED)
{
...
u8 *serialize_onionpacket(const tal_t *ctx UNNEEDED,
...
bool sphinx_add_hop_has_length(struct sphinx_path *path UNNEEDED,
...
struct sphinx_path *
sphinx_path_new_with_key(const tal_t *ctx UNNEEDED,
			 const u8 *associated_data UNNEEDED,
...
void subd_release_channel(struct subd *owner UNNEEDED,
			  const void *channel UNNEEDED)
{
...
struct subd_req *
subd_req_(const tal_t *ctx UNNEEDED, struct subd *sd UNNEEDED,
	  const u8 *msg_out UNNEEDED, int fd_out UNNEEDED,
	  size_t num_fds_in UNNEEDED,
	  void (*replycb)(struct subd *UNNEEDED, const u8 *UNNEEDED,
			  const int *UNNEEDED, void *) UNNEEDED,
...
const char *to_canonical_invstr(const tal_t *ctx UNNEEDED,
...
u8 *towire_channeld_fail_htlc(const tal_t *ctx UNNEEDED,
			      const struct failed_htlc *failed_htlc UNNEEDED)
{
	fprintf(stderr, "towire_channeld_fail_htlc called!\n");
	abort();
}
/* Generated stub for towire_channeld_fulfill_htlc */
u8 *towire_channeld_fulfill_htlc(const tal_t *ctx UNNEEDED,
				 const struct fulfilled_htlc *fulfilled_htlc
				     UNNEEDED)
{
...
u8 *towire_channeld_offer_htlc(const tal_t *ctx UNNEEDED,
			       struct amount_msat amount_msat UNNEEDED,
			       u32 cltv_expiry UNNEEDED,
			       const struct sha256 *payment_hash UNNEEDED,
			       const u8 onion_routing_packet[1366] UNNEEDED,
			       const struct pubkey *blinding UNNEEDED)
{
...
u8 *towire_connectd_peer_connect_subd(
    const tal_t *ctx UNNEEDED, const struct node_id *id UNNEEDED,
    u64 counter UNNEEDED, const struct channel_id *channel_id UNNEEDED)
{
...
u8 *towire_connectd_peer_final_msg(const tal_t *ctx UNNEEDED,
				   const struct node_id *id UNNEEDED,
				   u64 counter UNNEEDED, const u8 *msg UNNEEDED)
{
...
u8 *towire_expiry_too_soon(const tal_t *ctx UNNEEDED,
...
u8 *towire_fee_insufficient(const tal_t *ctx UNNEEDED,
			    struct amount_msat htlc_msat UNNEEDED,
			    const u8 *channel_update UNNEEDED)
{
...
u8 *towire_final_incorrect_cltv_expiry(const tal_t *ctx UNNEEDED,
				       u32 cltv_expiry UNNEEDED)
{
...
u8 *towire_final_incorrect_htlc_amount(
    const tal_t *ctx UNNEEDED, struct amount_msat incoming_htlc_amt UNNEEDED)
{
	fprintf(stderr, "towire_final_incorrect_htlc_amount called!\n");
	abort();
}
/* Generated stub for towire_gossipd_discovered_ip */
u8 *towire_gossipd_discovered_ip(const tal_t *ctx UNNEEDED,
				 const struct wireaddr *discovered_ip UNNEEDED)
{
	fprintf(stderr, "towire_gossipd_discovered_ip called!\n");
	abort();
}
/* Generated stub for towire_hsmd_check_pubkey */
u8 *towire_hsmd_check_pubkey(const tal_t *ctx UNNEEDED, u32 index UNNEEDED,
			     const struct pubkey *pubkey UNNEEDED)
{
...
u8 *towire_hsmd_client_hsmfd(const tal_t *ctx UNNEEDED,
			     const struct node_id *id UNNEEDED,
			     u64 dbid UNNEEDED, u64 permissions UNNEEDED)
{
	fprintf(stderr, "towire_hsmd_client_hsmfd called!\n");
	abort();
}
/* Generated stub for towire_hsmd_derive_secret */
u8 *towire_hsmd_derive_secret(const tal_t *ctx UNNEEDED,
			      const u8 *info UNNEEDED)
{
...
u8 *towire_hsmd_get_output_scriptpubkey(
    const tal_t *ctx UNNEEDED, u64 channel_id UNNEEDED,
    const struct node_id *peer_id UNNEEDED,
    const struct pubkey *commitment_point UNNEEDED)
{
...
u8 *towire_hsmd_init(
    ...
    const struct bip32_key_version *bip32_key_version UNNEEDED,
    const struct chainparams *chainparams UNNEEDED,
    const struct secret *hsm_encryption_key UNNEEDED,
    const struct privkey *dev_force_privkey UNNEEDED,
    const struct secret *dev_force_bip32_seed UNNEEDED,
    const struct secrets *dev_force_channel_secrets UNNEEDED,
    const struct sha256 *dev_force_channel_secrets_shaseed UNNEEDED,
    u32 hsm_wire_min_version UNNEEDED, u32 hsm_wire_max_version UNNEEDED)
{
	fprintf(stderr, "towire_hsmd_init called!\n");
	abort();
}
/* Generated stub for towire_hsmd_new_channel */
u8 *towire_hsmd_new_channel(const tal_t *ctx UNNEEDED,
			    const struct node_id *id UNNEEDED,
			    u64 dbid UNNEEDED)
{
...
u8 *towire_hsmd_forget_channel(const tal_t *ctx UNNEEDED,
			       const struct node_id *id UNNEEDED,
			       u64 dbid UNNEEDED)
{
...
u8 *towire_hsmd_sign_commitment_tx(
    const tal_t *ctx UNNEEDED, const struct node_id *peer_id UNNEEDED,
    u64 channel_dbid UNNEEDED, const struct bitcoin_tx *tx UNNEEDED,
    const struct pubkey *remote_funding_key UNNEEDED, u64 commit_num UNNEEDED)
{
	fprintf(stderr, "towire_hsmd_sign_commitment_tx called!\n");
	abort();
}
/* Generated stub for towire_incorrect_cltv_expiry */
u8 *towire_incorrect_cltv_expiry(const tal_t *ctx UNNEEDED,
				 u32 cltv_expiry UNNEEDED,
				 const u8 *channel_update UNNEEDED)
{
...
u8 *towire_incorrect_or_unknown_payment_details(
    const tal_t *ctx UNNEEDED, struct amount_msat htlc_msat UNNEEDED,
    u32 height UNNEEDED)
{
	fprintf(stderr,
		"towire_incorrect_or_unknown_payment_details called!\n");
	abort();
}
/* Generated stub for towire_invalid_onion_blinding */
u8 *towire_invalid_onion_blinding(const tal_t *ctx UNNEEDED,
				  const struct sha256 *sha256_of_onion UNNEEDED)
{
	fprintf(stderr, "towire_invalid_onion_blinding called!\n");
	abort();
}
/* Generated stub for towire_invalid_onion_payload */
u8 *towire_invalid_onion_payload(const tal_t *ctx UNNEEDED,
				 bigsize type UNNEEDED, u16 offset UNNEEDED)
{
...
u8 *towire_onchaind_known_preimage(const tal_t *ctx UNNEEDED,
				   const struct preimage *preimage UNNEEDED)
{
...
u8 *towire_temporary_channel_failure(const tal_t *ctx UNNEEDED,
				     const u8 *channel_update UNNEEDED)
{
...
void try_reconnect(const tal_t *ctx UNNEEDED, struct peer *peer UNNEEDED,
...
struct txwatch *
watch_txid_(const tal_t *ctx UNNEEDED, struct chain_topology *topo UNNEEDED,
	    const struct bitcoin_txid *txid UNNEEDED,
	    enum watch_result (*cb)(struct lightningd *ld UNNEEDED,
				    const struct bitcoin_txid *UNNEEDED,
				    const struct bitcoin_tx *UNNEEDED,
				    unsigned int depth UNNEEDED, void *arg)
		UNNEEDED,
	    void *arg UNNEEDED)
{
...
struct txowatch *
watch_txo(const tal_t *ctx UNNEEDED, struct chain_topology *topo UNNEEDED,
	  struct channel *channel UNNEEDED,
	  const struct bitcoin_outpoint *outpoint UNNEEDED,
...
u8 *towire_hsmd_get_channel_basepoints(const tal_t *ctx UNNEEDED,
				       const struct node_id *peerid UNNEEDED,
				       u64 dbid UNNEEDED)
{
	return NULL;
}
...
u8 *wire_sync_read(const tal_t *ctx UNNEEDED, int fd UNNEEDED) { return NULL; }
...
struct logger *new_logger(const tal_t *ctx UNNEEDED,
			  struct log_book *record UNNEEDED,
...
void txfilter_add_scriptpubkey(struct txfilter *filter UNNEEDED,
			       const u8 *script TAKES)
{
	if (taken(script))
		tal_free(script);
}
...
static struct wallet *create_test_wallet(struct lightningd *ld,
					 const tal_t *ctx)
{
	char *dsn, *filename;
...
static bool test_wallet_outputs(struct lightningd *ld, const tal_t *ctx)
{
	...
	CHECK_MSG(wallet_update_output_status(w, &u.outpoint, OUTPUT_STATE_ANY,
					      OUTPUT_STATE_SPENT),
	...
	*blockheight = 100;
	...
	CHECK_MSG(wallet_add_onchaind_utxo(w, &u.outpoint, u.scriptPubkey,
					   *u.blockheight, AMOUNT_SAT(3),
					   &channel, NULL, 5),
	...
	CHECK(u.close_info->channel_id == 42 &&
	      u.close_info->commitment_point == NULL &&
	      node_id_eq(&u.close_info->peer_id, &id) &&
	      u.close_info->option_anchors == true && u.close_info->csv == 1);
	/* Now un-reserve them */
	tal_free(utxos);
...
static bool test_shachain_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	CHECK_MSG(memcmp(&a, &b, sizeof(a)) == 0,
		  "Loading from database doesn't match");
...
{
	CHECK(memeq(&i1->funding->outpoint.txid, sizeof(struct sha256_double),
		    &i2->funding->outpoint.txid, sizeof(struct sha256_double)));
	CHECK(i1->funding->outpoint.n == i2->funding->outpoint.n);
	CHECK(i1->funding->feerate == i2->funding->feerate);
	CHECK(
	    amount_sat_eq(i1->funding->total_funds, i2->funding->total_funds));
	CHECK(amount_sat_eq(i1->funding->our_funds, i2->funding->our_funds));
	CHECK(memeq(&i1->last_sig, sizeof(i1->last_sig), &i2->last_sig,
		    sizeof(i2->last_sig)));
...
static bool channelseq(struct channel *c1, struct channel *c2)
{
	...
	struct changed_htlc *lc1 = c1->last_sent_commit,
			    *lc2 = c2->last_sent_commit;
	...
	CHECK((c1->shutdown_scriptpubkey[REMOTE] == NULL &&
	       c2->shutdown_scriptpubkey[REMOTE] == NULL) ||
	      memeq(c1->shutdown_scriptpubkey[REMOTE],
	...
	CHECK(
	    pubkey_eq(&ci1->theirbase.revocation, &ci2->theirbase.revocation));
	CHECK(pubkey_eq(&ci1->theirbase.payment, &ci2->theirbase.payment));
	CHECK(pubkey_eq(&ci1->theirbase.delayed_payment,
			&ci2->theirbase.delayed_payment));
	CHECK(pubkey_eq(&ci1->remote_per_commit, &ci2->remote_per_commit));
	CHECK(pubkey_eq(&ci1->old_remote_per_commit,
			&ci2->old_remote_per_commit));
	CHECK(ci1->their_config.id != 0 &&
	      ci1->their_config.id == ci2->their_config.id);
	...
	CHECK(memeq(&c1->last_sig, sizeof(c1->last_sig), &c2->last_sig,
		    sizeof(c2->last_sig)));
	...
	for (enum htlc_state i = 0;
	     i < ARRAY_SIZE(c1->blockheight_states->height); i++) {
...
static bool test_channel_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	secp256k1_ecdsa_signature *node_sig1 =
	    tal(w, secp256k1_ecdsa_signature);
	secp256k1_ecdsa_signature *bitcoin_sig1 =
	    tal(w, secp256k1_ecdsa_signature);
	...
	c1.last_tx = bitcoin_tx_from_hex(
	    w,
	    ...
	    "00160014ccf1af2f2aabee14bb40fa3851ab2301de843110ae8f6a000000000022"
	    "00204adb4e2f00643db396dd120d4e7dc17625f5f2c11a40d857accc862d6b7dd8"
	    "0e040047304402206a2679efa3c7aaffd2a447fd0df7aba8792858b589750f6a12"
	    "03f9259173198a022008d52a0e77a99ab533c36206cb15ad7aeb2aa72b93d4b571"
	    "e728cb5ec2f6fe260147304402206d6cb93969d39177a09d5d45b583f34966195b"
	    "77c7e585cf47ac5cce0c90cefb022031d71ae4e33a4e80df7f981d696fbdee5173"
	    "37806a3c7138b7491e2cbb077a0e01475221023da092f6980e58d2c037173180e9"
	    "a465476026ee50f96695963e8efe436f54eb21030e9f7b623d2ccc7c9bd44d66d5"
	    "ce21ce504c0acf6385a132cec6d3c39fa711c152ae3e195220",
	    strlen(
		"02000000000101bef67e4e2fb9ddeeb3461973cd4c62abb35050b1add77299"
		"5b820b584a488489000000000038b02b8003a00f0000000000002200208c48"
		"d15160397c9731df9bc3b236656efb6665fbfe92b4a6878e88a499f741c4c0"
		"c62d0000000000160014ccf1af2f2aabee14bb40fa3851ab2301de843110ae"
		"8f6a00000000002200204adb4e2f00643db396dd120d4e7dc17625f5f2c11a"
		"40d857accc862d6b7dd80e040047304402206a2679efa3c7aaffd2a447fd0d"
		"f7aba8792858b589750f6a1203f9259173198a022008d52a0e77a99ab533c3"
		"6206cb15ad7aeb2aa72b93d4b571e728cb5ec2f6fe260147304402206d6cb9"
		"3969d39177a09d5d45b583f34966195b77c7e585cf47ac5cce0c90cefb0220"
		"31d71ae4e33a4e80df7f981d696fbdee517337806a3c7138b7491e2cbb077a"
		"0e01475221023da092f6980e58d2c037173180e9a465476026ee50f9669596"
		"3e8efe436f54eb21030e9f7b623d2ccc7c9bd44d66d5ce21ce504c0acf6385"
	...
	CHECK_MSG(c2 = wallet_channel_load(w, c1.dbid),
		  tal_fmt(w, "Load from DB"));
	CHECK_MSG(!wallet_err, tal_fmt(w, "Load from DB: %s", wallet_err));
	...
	CHECK_MSG(load = wallet_remote_ann_sigs_load(w, w, c1.dbid, &node_sig2,
						     &bitcoin_sig2),
		  tal_fmt(w, "Load ann sigs from DB"));
	CHECK_MSG(!wallet_err,
		  tal_fmt(w, "Load ann sigs from DB: %s", wallet_err));
	CHECK(load == true);
	CHECK_MSG(!memcmp(node_sig1, node_sig2, sizeof(*node_sig1)),
		  "Compare ann sigs loaded with saved (v5)");
	CHECK_MSG(!memcmp(bitcoin_sig1, bitcoin_sig2, sizeof(*node_sig1)),
		  "Compare ann sigs loaded with saved (v5)");
...
static bool test_channel_inflight_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	last_tx = bitcoin_tx_from_hex(
		...
		"3e8efe436f54eb21030e9f7b623d2ccc7c9bd44d66d5ce21ce504c0acf6385"
		"a132cec6d3c39fa711c152ae3e195220"));
	funding_psbt = psbt_from_b64(
	    w,
	    "cHNidP8BAKACAAAAAqsJSaCMWvfEm4IS9Bfi8Vqz9cM9zxU4IagTn4d6W3vkAAAAAA"
	    "D+////qwlJoIxa98SbghL0F+LxWrP1wz3PFTghqBOfh3pbe+QBAAAAAP7///"
	    "8CYDvqCwAAAAAZdqkUdopAu9dAy+"
	    "gdmI5x3ipNXHE5ax2IrI4kAAAAAAAAGXapFG9GILVT+glechue4O/"
	    "p+"
	    "gOcykWXiKwAAAAAAAEHakcwRAIgR1lmF5fAGwNrJZKJSGhiGDR9iYZLcZ4ff89X0eU"
	    "RZYcCIFMJ6r9Wqk2Ikf/REf3xM286KdqGbX+EhtdVRs7tr5MZASEDXNxh/"
	    "HupccC1AaZGoqg7ECy0OIEhfKaC3Ibi1z+"
	    "ogpIAAQEgAOH1BQAAAAAXqRQ1RebjO4MsRwUPJNPuuTycA5SLx4cBBBYAFIXRNTfy4"
	    "mVAWjTbr6nj3aAfuCMIAAAA",
	    strlen(
		"cHNidP8BAKACAAAAAqsJSaCMWvfEm4IS9Bfi8Vqz9cM9zxU4IagTn4d6W3vkAA"
		"AAAAD+////qwlJoIxa98SbghL0F+LxWrP1wz3PFTghqBOfh3pbe+QBAAAAAP7/"
		"//"
		"8CYDvqCwAAAAAZdqkUdopAu9dAy+"
		"gdmI5x3ipNXHE5ax2IrI4kAAAAAAAAGXapFG9GILVT+glechue4O/"
		"p+"
		"gOcykWXiKwAAAAAAAEHakcwRAIgR1lmF5fAGwNrJZKJSGhiGDR9iYZLcZ4ff89"
		"X0eURZYcCIFMJ6r9Wqk2Ikf/REf3xM286KdqGbX+EhtdVRs7tr5MZASEDXNxh/"
		"HupccC1AaZGoqg7ECy0OIEhfKaC3Ibi1z+"
		"ogpIAAQEgAOH1BQAAAAAXqRQ1RebjO4MsRwUPJNPuuTycA5SLx4cBBBYAFIXRN"
		"Tfy4mVAWjTbr6nj3aAfuCMIAAAA"));
	feerate = 192838;
	...
	chan = new_channel(
	    p, wallet_get_channel_dbid(w), NULL, DUALOPEND_AWAITING_LOCKIN,
	    LOCAL, NULL, "billboard", 8, false, false, &our_config, 101, 1, 1,
	    1, &outpoint, funding_sats, AMOUNT_MSAT(0), our_sats, 0, false,
	    NULL, /* alias[LOCAL] */
	    NULL, /* alias[REMOTE] */
	    &cid, AMOUNT_MSAT(3333333000), AMOUNT_MSAT(33333),
	    AMOUNT_MSAT(3333333333), last_tx, &sig, NULL, channel_info,
	    new_fee_states(w, LOCAL, &feerate), NULL, NULL, 1, false, NULL,
	    100,   /* first_blocknum */
	    100,   /* min_possible_feerate */
	    10000, /* max_possible_feerate */
	    &basepoints, &pk, NULL, 1000, 100, NULL, 0, 0,
	    channel_type_static_remotekey(NULL), LOCAL, REASON_UNKNOWN, NULL,
	    new_height_states(w, LOCAL, &lease_blockheight_start), 100,
	    lease_commit_sig, 7777, 22, AMOUNT_MSAT(0), AMOUNT_MSAT(-1ULL),
	    false, NULL, NULL /* complete_state */,
	...
	inflight =
	    new_inflight(chan, &outpoint, 253, funding_sats, our_sats,
			 funding_psbt, 1, lease_commit_sig, 2, 4, 22,
			 AMOUNT_MSAT(10), AMOUNT_SAT(1111), 0, false, false);
	...
	mempat(&sig.s, sizeof(sig.s));
	inflight = new_inflight(chan, &outpoint, 300, funding_sats, our_sats,
				funding_psbt, 0, NULL, 0, 0, 0, AMOUNT_MSAT(0),
				AMOUNT_SAT(0), 0, false, false);
	inflight_set_last_tx(inflight, last_tx, sig);
	wallet_inflight_add(w, inflight);
	CHECK_MSG(c2 = wallet_channel_load(w, chan->dbid),
		  tal_fmt(w, "Load from DB"));
	...
	funding_psbt =
	    psbt_from_b64(w,
			  "cHNidP8BAD8CAAAAAf//////////////////////////////////"
			  "////////AAAAAAD/////"
			  "AQAAAAAAAAAAA2oBAAAAAAAADfwB7g8BAgMEBQYHCAkPAQIDBAUG"
			  "BwgJCgsMDQ4PAAA=",
			  strlen("cHNidP8BAD8CAAAAAf///////////////////////////"
				 "///////////////AAAAAAD/////"
				 "AQAAAAAAAAAAA2oBAAAAAAAADfwB7g8BAgMEBQYHCAkPA"
				 "QIDBAUGBwgJCgsMDQ4PAAA="));
	list_for_each(&chan->inflights, inflight, list) inflight->funding_psbt =
	    funding_psbt;
...
static bool test_channel_config_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	CHECK(transaction_wrap(w->db,
			       wallet_channel_config_load(w, cc1->id, cc2)));
...
static bool test_htlc_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	/* Update */
	CHECK_MSG(transaction_wrap(
		      w->db, wallet_htlc_update(w, in.dbid, RCVD_ADD_HTLC, NULL,
						0, 0, NULL, NULL, false)),
		  "Update HTLC with null payment_key failed");
	CHECK_MSG(transaction_wrap(
		      w->db, wallet_htlc_update(w, in.dbid, SENT_REMOVE_HTLC,
						&payment_key, 0, 0, NULL, NULL,
						false)),
		  "Update HTLC with payment_key failed");
	onionreply = new_onionreply(tmpctx, tal_arrz(tmpctx, u8, 100));
	CHECK_MSG(
	    transaction_wrap(
		w->db, wallet_htlc_update(w, in.dbid, SENT_REMOVE_HTLC, NULL, 0,
					  0, onionreply, NULL, false)),
	    "Update HTLC with failonion failed");
	CHECK_MSG(
	    transaction_wrap(
		w->db, wallet_htlc_update(w, in.dbid, SENT_REMOVE_HTLC, NULL, 0,
					  WIRE_INVALID_ONION_VERSION, NULL,
					  NULL, false)),
	...
	wallet_err = tal_free(wallet_err);
	CHECK_MSG(transaction_wrap(
		      w->db, wallet_htlc_update(
				 w, out.dbid, SENT_ADD_ACK_REVOCATION, NULL, 0,
				 0, NULL, tal_arrz(tmpctx, u8, 100), false)),
...
static bool test_payment_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	t = wallet_add_payment(ctx, w, 1, NULL, &payment_hash, 0, 12345,
			       PAYMENT_PENDING, &destination, AMOUNT_MSAT(100),
			       AMOUNT_MSAT(101), AMOUNT_MSAT(100), NULL, NULL,
...
int main(int argc, const char *argv[])
{
	...
	ld->rr_counter = 0;
	node_id_from_hexstr("02a1633cafcc01ebfb6d78e39f687a1f0995c62fc95f51ead1"
			    "0a02ee0be551b5dc",
			    66, &ld->id);
